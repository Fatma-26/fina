...
<div className="SignUp" style={{width: 1440, height: 1024, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 10, display: 'inline-flex'}}>
  <div className="Group2" style={{width: 1440, height: 1024, position: 'relative'}}>
    <div className="Desktop1" style={{width: 1440, height: 1024, left: 0, top: 0, position: 'absolute', background: 'white', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 39, display: 'inline-flex'}}>
      ...
      <div className="SignUp" style={{left: 424, top: 205, position: 'absolute', color: '#094546', fontSize: 32, fontFamily: 'Inter', fontWeight: '600', wordWrap: 'break-word'}}>Sign up</div>
      <div className="Frame19" style={{height: 121, left: 424, top: 264, position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 15, display: 'flex'}}>
        <div className="EnterYourEmail" style={{alignSelf: 'stretch', color: '#094546', fontSize: 32, fontFamily: 'Inter', fontWeight: '300', wordWrap: 'break-word'}}>Email address</div>
      ...
      <div className="Frame20" style={{height: 121, left: 424, top: 399, position: 'absolute', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 15, display: 'flex'}}>
        <div className="EnterYourEmail" style={{alignSelf: 'stretch', color: '#094546', fontSize: 32, fontFamily: 'Inter', fontWeight: '300', wordWrap: 'break-word'}}>password </div>
        <div className="Rectangle5" style={{alignSelf: 'stretch', height: 67, background: 'white', borderRadius: 11, border: '1px #FFF9F9 solid'}} />
      </div>
    ...
    <img className="Image2" style={{width: 55, height: 56, left: 472, top: 790, position: 'absolute'}} src="https://via.placeholder.com/55x56" />
  </div>
</div>
)
}